...
# Convert into a table that can be used for the chi square test
chisq.table = table(data_currentwave_wavemin1$BI1a_UTAUT_agree_cw, data_currentwave_wavemin1$BI1a_UTAUT_agree_wmin1)
...
##### Intentie tot opvolgen adviezen gegeven in de melding over de tijd
...
##### Intentie tot opvolgen adviezen gegeven in de melding - alleen huidg gebruikers over de tijd
