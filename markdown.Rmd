...
mcnemartest = mcnemar.test(mcnemar.table)
if( sum(mcnemar.table) != 1594) stop('mcnemar table does not sum up to 1594')
```
...
De angst is over tijd licht afgenomen: waar vorige meting 21% aangaf de CoronaMelder eng te vinden, is dat in de huidige meting 15%. Ook zou men minder snel angstig worden bij het ontvangen van een melding vanuit de CoronaMelder (nu: 28%; vorige meting: 30.7%). Wellicht is dit een gevolg van de positieve media-aandacht omtrent de CoronaMelder, waarbij misvattingen over bijvoorbeeld privacy (deels) de wereld uit zijn geholpen.
