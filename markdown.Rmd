...
# Calculate a proportion for the variable for the previous wave. 
data_currentwave_wavemin1$Beliefs_civicduty_agree_wmin1[(data_currentwave_wavemin1$Beliefs_civicduty_cw == 'Helemaal mee eens'| data_currentwave_wavemin1$Beliefs_civicduty_wmin1 == 'Mee eens'| data_currentwave_wavemin1$Beliefs_civicduty_wmin1 == 'Een beetje mee eens')] <- "Totaal eens_wmin1"
