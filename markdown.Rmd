...
data_currentwave_wavemin1 = merge(data_wave_min1, data, by = "nomem_encr", all = FALSE, suffix = c("_cw", "_wmin1")) # all = FALSE to only include IDs present in both datasets.
